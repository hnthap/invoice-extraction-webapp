...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[880px]
        mx-auto mt-10 text-center'>Turn text to 
        ...
        >Unless your creatve with AI. Turn your imagination into visual art in second - just type, and watch the magic happen.</motion.p>
